...
public final class Config {
    ...
    public static double sqrt_alpha					= 0.15;
    ...
    public static String clusterDir				    = "/Users/Mao/Documents/workspace/FastSimrank-refactored";
...
//        File f = new File("config.properties");
    	File f = new File("config_AP.properties");
        if (!f.exists()) {
